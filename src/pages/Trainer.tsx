      ...
      <div className="container-px max-w-6xl mx-auto">
        ...
        <section className="grid lg:grid-cols-5 gap-10 mb-20 items-center">
          ...
          <div className="lg:col-span-3">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              I'm a fitness coach based in Nashik with one mission — to help
              everyday people build the body, energy and confidence they
              deserve. Over the past 8 years, I've coached 500+ clients through
              fat loss, muscle building, strength and lifestyle transformations
              using science-backed methods built around real Indian living.
            </p>
        ...
        <section className="mb-16">
          <div className="p-7 md:p-10 rounded-3xl bg-card border border-border">
            <h2 className="font-display text-3xl md:text-4xl tracking-wide mb-5">
              My Coaching Philosophy
            </h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed text-base md:text-lg">
              <p>
                I don't believe in shortcuts, crash diets, or "transformations"
                you can't sustain. My job is to teach you a system — training,
                nutrition and habits — that fits your real life.
              </p>
              <p>
                Every plan is built from scratch around your goals, body type,
                schedule and food preferences. You'll never feel like you're
                starving, lost or doing this alone.
              </p>
              <p className="text-foreground font-semibold">
                Show up. Trust the process. Get results that last.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="text-center p-8 md:p-12 rounded-3xl bg-gradient-to-br from-primary/15 via-card to-card border border-primary/40 shadow-glow">
          ...
          <p className="text-muted-foreground mb-7 max-w-lg mx-auto">
            Book a free consultation and let's design your transformation plan
            together.
          </p>
          <a
            href={waLink(
              "Hi Ajinkya, I'd like to book a training session with GO FIT",
            )}
            target="_blank"
            rel="noopener"
